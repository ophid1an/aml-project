...
# Calibrated models
classifiers = {
    "RF": {"f": CalibratedClassifierCV(RandomForestClassifier(random_state=RANDOM_STATE), cv=10, method='sigmoid')},
    "LSVM": {"f": CalibratedClassifierCV(LinearSVC(random_state=RANDOM_STATE), cv=10, method='sigmoid')},
