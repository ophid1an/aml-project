...
for model in classifiers.keys():
    ...
    tempO= binary_classification_metrics(y_test, classifiers[model]["c"], classifiers[model]["p"][:, 1])#various statistics
...
for model in list(ci_models):
    ...
    tempBMR =binary_classification_metrics(y_test, classifiers[model + "-BMR"]["c"], classifiers[model]["p"][:, 0])  # various statistics
    ...
    tempTO =binary_classification_metrics(y_test, classifiers[model + "-TO"]["c"], classifiers[model]["p"][:, 0]) # various statistics
...
for model in CostSensitiveClassifiers .keys():
    ...
    temp=binary_classification_metrics(y_test,CostSensitiveClassifiers[model]["c"], CostSensitiveClassifiers[model]["c_p"] [:, 0]) # various statistics
